...
public class OfferScreen {
    ...
    public void print() {
        String reservationNumber = purchaseProcess.getReservation(loginScreen.getClient().getNumber());
        try {
    ...
    private void askForConfirmation(Offer offer, String reservationNumber) {
        ...
        if(answer.equals("t")) {
            try {
                ...
                System.out.println("Brawo, dziękujęmy, gratulujemy właściwej decyzji");
            }
